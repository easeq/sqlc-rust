...
impl Queries {
    ...
    pub(crate) async fn delete_venue(&mut self, slug: String) -> anyhow::Result<()> {
        self.client.execute(DELETE_VENUE, &[&slug]).await?;
        Ok(())
    }
    pub(crate) async fn get_city(&mut self, slug: String) -> anyhow::Result<City> {
    ...
    pub(crate) async fn list_cities(&mut self) -> anyhow::Result<Vec<City>> {
