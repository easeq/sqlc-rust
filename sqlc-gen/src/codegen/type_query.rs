...
mod tests {
    ...
    fn test_sync_function_signature() {
        ...
        let expected_tokens = quote! {
            pub fn example_query(client: impl sqlc_core::DBTX, param: i32) -> sqlc_core::Result<()> {
    ...
    fn test_async_function_signature() {
        ...
        let expected_tokens = quote! {
            pub async fn example_query(client: impl sqlc_core::DBTX, param: i32) -> sqlc_core::Result<()> {
