...
select book_id, author_id, isbn, book_type, title, year, price, available, tags
from books
"#;
...
RETURNING book_id, author_id, isbn, book_type, title, year, price, available, tags
"#;
...
pub struct Book {
    ...
    pub title: String,
    pub year: i32,
    pub price: sqlc_core::rust_decimal::Decimal,
...
pub async fn get_biography<'a, C, I>(
    client: &'a C,
    author_id_list: I,
) -> sqlc_core::Result<sqlc_core::BatchStream<sqlc_core::serde_json::Value>>
where
    C: sqlc_core::DBTX,
    I: IntoIterator + Send + 'a,
    I::IntoIter: Send,
